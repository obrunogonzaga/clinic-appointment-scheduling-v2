...
import { Search, Filter, X, User, Phone, MapPin, Calendar, Heart } from 'lucide-react';
...
const PatientSearch = ({ onSearch, onFilterChange, totalResults = 0 }) => {
  ...
  const getActiveFiltersCount = () => {
    return Object.entries(filters).filter(([key, value]) => 
      value !== 'all' && value !== '' && key !== 'customDateFrom' && key !== 'customDateTo'
    ).length + (filters.customDateFrom || filters.customDateTo ? 1 : 0);
  };
